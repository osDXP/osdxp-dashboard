 ...
 <div id="dxp-actions">
	...
	<div class="row large">
		...
		<?php if (current_user_can('publish_posts')) : ?>
			<a href="<?php echo admin_url('post-new.php'); ?>" class="col">
				<div class="postbox">
					<div>
						<div class="group">
		...
		<?php if ((current_user_can('publish_pages') || current_user_can('publish_posts')) && class_exists('CFConditionalContent')) : ?>
			<a href="<?php echo admin_url('post-new.php?post_type=cf_cc_condition'); ?>" class="col">
				<div class="postbox">
					<div>
						<div class="group">
						...
						<div class="button button-primary"><?php esc_html_e('New Condition', 'osdxp-dashboard'); ?></div>
					</div>
				</div>
			</a>
		<?php endif; ?>
	...
	<div class="row">
		...
		<?php if (current_user_can('edit_posts')) : ?>
			<a href="<?php echo admin_url('edit.php'); ?>" class="col">
		 		<div class="postbox">
		 			<div>
						<div class="group">
							<div class="dashicons-before dashicons-text-page"></div>
		...
		<?php if ((current_user_can('publish_pages') || current_user_can('publish_posts')) && class_exists('CFConditionalContent')) : ?>
			<a href="<?php echo admin_url('admin.php?page=cf-conditional-content-settings'); ?>" class="col">
		 		<div class="postbox">
		 			<div>
						<div class="group">
							<div class="dashicons-before dashicons-admin-post"></div>
		...
		<?php if (current_user_can('upload_files')) : ?>
			<a href="<?php echo admin_url('upload.php'); ?>" class="col">
		 		<div class="postbox">
		 			<div>
						<div class="group">
